...
import br.gov.previc.dados.consulta.resposta.ItemRespostaHabilitacoesAnexo;
...
@Stateless
public class HabilitacoesAnexoWS implements IHabilitacoesAnexoWS{
	@EJB
	public DadosDaoInterface dao;
	static final Logger logger = LogManager.getLogger();
	public HabilitacoesAnexoWS(){	
	}
	public Response doConsulta(UriInfo uriInfo, HttpServletRequest request, Integer id) {
		...
		mapaParametro.put("idHabilitacao", id);
		return 	doConsultaGenerica(request, mapaParametro, "HabilitacoesAnexoModel.findByIdHabilitacao");	
	}
	@Override
	public Response doConsultaPorIdCadastroSpc(UriInfo uriInfo, HttpServletRequest request, Integer id) {
		...
		return 	doConsultaGenerica(request, mapaParametro, "HabilitacoesAnexoModel.findByIdCadastroSpc");	
	}
	public Response doConsultaGenerica(HttpServletRequest request,  Map<String, Object> mapaParametro, String query) {
		try{
			...
			RespostaConsulta resultadoConsulta = new RespostaConsulta(recuperados.stream()
					.map(r -> new ItemRespostaHabilitacoesAnexo((HabilitacoesAnexoModel) r)).collect(Collectors.toList()));
