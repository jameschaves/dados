...
@Stateless
public class DadosXQueryConsultaHabilitacaoPorNomeWS implements IDadosXQueryWS{
	@EJB
	...
	static final String sql = "DECLARE @xmlHabilitacao XML;\r\n" + 
			...
			"  WHERE NM_PESSOA_FISICA_SPC LIKE :nome \r\n" + 
	...
	public DadosXQueryConsultaHabilitacaoPorNomeWS(){	
	}
	@Override
	public Response doConsulta(UriInfo uriInfo, HttpServletRequest request) {
		...
		String nome = uriInfo.getPathParameters().getFirst("nome");
